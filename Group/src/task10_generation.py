...
def generate_with_citation(
    ...
    chunks = retrieve(retrieval_query, top_k=top_k, use_hybrid=use_hybrid, use_reranker=use_reranker)
    ...
    try:
        if OPENAI_API_BASE == "https://openrouter.ai/api/v1" and OPENAI_API_KEY.startswith("sk-proj"):
            # Use native OpenAI base url if it's an OpenAI key but base url defaulted to OpenRouter
